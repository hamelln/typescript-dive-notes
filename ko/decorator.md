...
이제는 고급 원두 머신을 많이 사용합니다. 메뉴도 많아졌습니다. 메소드를 많이 추가해야겠군요.
...
커피 브랜드와 머신 종류도 많아졌고 레시피도 제각각입니다. 인터페이스로 틀을 만들고 각 객체마다 구현을 맡깁시다.  
...
- 각 브랜드와 머신은 공통되는 공정이 있습니다: 원두 분쇄, 우유 데우기 등...
- 각 브랜드와 머신은 레시피가 다릅니다: 원두를 분쇄하는 양, 우유를 데우는 양...

카페라떼는 브랜드마다 레시피가 다릅니다. 브랜드 고유 레시피로 시나몬, 혹은 시럽을 넣을 수도 있습니다. 그러나 적어도 **원두를 분쇄하고 에스프레소를 만들고 데운 우유를 사용한다**는 로직은 모두 동일합니다.  
수치만 다를 뿐 공정이 똑같습니다. 브랜드와 머신이 많아질수록 굉장히 뻐근하겠네요. 어떻게 해야 좋을까요? 이렇게 재사용성이 충분한 로직은 데코레이터로 분리하는 방법이 있습니다.
...
어떤가요? 위 데코레이터를 응용하면 숫자만 바꿈으로서 수많은 케이스에 재사용할 수 있습니다. 
